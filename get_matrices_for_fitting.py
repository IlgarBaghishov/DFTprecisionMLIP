...
ase_scraper(fs_instance, df_structures["ASEatoms"].values[a1:a2], df_energies['energy'].values[a1:a2],
            df_energies["forces"].values[a1:a2], df_energies["stress"].values[a1:a2])
